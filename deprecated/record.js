...
module.exports = {
	data: new SlashCommandBuilder()
        ...
        .addStringOption(option =>
            option.setName('dueltype')
            .setDescription('The type of record to create (think alternatives to bomb and blade).')
            .setRequired(true))
	...
	async execute(interaction) {
        ...
        //const duelType = interaction.option.getString('dueltype');
